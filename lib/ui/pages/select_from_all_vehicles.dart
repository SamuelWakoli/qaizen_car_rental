...
class SelectFromAllVehicles extends StatefulWidget {
  const SelectFromAllVehicles({Key? key}) : super(key: key);

  @override
  State<SelectFromAllVehicles> createState() => _SelectFromAllVehiclesState();
}

class _SelectFromAllVehiclesState extends State<SelectFromAllVehicles> {
  String appBarTitle = 'All Vehicles';
          ...
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              return const ListTile(
                title: Text(
                    'No vehicles available at the moment. Please call us to reserve one.'),
              );
            }
